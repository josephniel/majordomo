...
class GmailConnector(Connector):
    ...
    def build_clients(self) -> dict[str, GmailClient]:
        ...
        below and the mail-watch poller (capabilities/mailwatch.py)."""
    ...
    def _build_tools_for_profile(self, client: GmailClient) -> list:
        ...
        async def search_emails_tool(args: dict[str, Any]):
            try:
        ...
        async def list_email_labels_tool(_args: dict[str, Any]):
            try:
        ...
        async def list_filters_tool(_args: dict[str, Any]):
            try:
