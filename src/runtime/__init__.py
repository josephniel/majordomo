"""runtime — persona identity, settings, composition root, entry point.

The only layer allowed to name concrete classes or read the environment;
everything below it receives its dependencies. `python -m runtime` starts a
persona on its configured chat platform.
